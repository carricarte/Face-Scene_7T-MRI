function cat12_seg(filename,spm_path)
    try
        ...
        matlabbatch{1}.spm.tools.cat.estwrite.extopts.restypes.optimal = [1 0.3]; %different
        ...
        matlabbatch{1}.spm.tools.cat.estwrite.extopts.WMHC = 3;
        matlabbatch{1}.spm.tools.cat.estwrite.extopts.registration.shooting.shootingtpm = {fullfile(spm_path,'/toolbox/cat12/templates_MNI152NLin2009cAsym/Template_0_GS.nii')};
